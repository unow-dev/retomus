...
var RetomusWrapperContext = createContext({
  refs: /* @__PURE__ */ new Map()
});
var RetomusWrapper = (props) => {
  const refs = useRef(/* @__PURE__ */ new Map());
  return /* @__PURE__ */ jsx(RetomusWrapperContext.Provider, { value: { refs }, children: props.children });
};
...
var Machine = class {
  ...
  createHooks() {
    const useMachineStatusIn = (machine) => () => {
      ...
      const subscribeStatus = useCallback2(
    ...
    const useMachineFlagIn = (machine) => (key) => {
      ...
      const subscribeFlag = useCallback2(
...
export {
  RetomusWrapper_default as RetomusWrapper,
